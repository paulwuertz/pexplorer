<script>
	...
	let settings_dummy = {
		threads: [
			{ thread_entry_name: 'log_process_thread_func', stack_variable_name: 'logging_stack' },
			{ thread_entry_name: 'bg_thread_main', stack_variable_name: 'z_main_stack' },
			{ thread_entry_name: 'gs_usb_rx_thread', size: 1024 },
			{ thread_entry_name: 'gs_usb_tx_thread', size: 1024 },
...
<div class="container" id="content">
	...
	<Container fluid>
		<!-- <Button color="success">Add Config</Button> -->
		<!-- <TabContent vertical pills>
        <TabPane tabId="alpha" tab="Active config" active> -->
		<SettingsEditor settings={settings_dummy}></SettingsEditor>
		<!-- </TabPane> -->
		<!-- <TabPane tabId="bravo" tab="TODO implement">
            <h2>Bravo</h2>
            <img
            alt="Johnny Bravo"
