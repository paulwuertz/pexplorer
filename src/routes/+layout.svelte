	...
	<Navbar color="light" light expand="md" container="md">
		...
		<Collapse {isOpen} navbar expand="md" on:update={handleUpdate}>
			<Nav class="ms-auto" navbar>
				<NavItem><NavLink data-sveltekit-preload-data="tap" href="{base}/">Browse (TODO)</NavLink></NavItem>
...
<div id="page-footer" class="container">
	<Container fluid>
		brought to you with &#128150; by data exported from puncover - <a
			href="https://twitter.com/hbehrens">Heiko Behrens</a
		>
		with some UI sugar by Paul Würtz
