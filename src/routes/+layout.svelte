...
<div id="page-footer" class="container" style="margin-bottom:30px;margin-top:30px;">
	<Container fluid>
		<div>
			...
			<span class="secondary">– MIT license, copyright &copy; 2014-2026</span>
		</div>
	</Container>
</div>
