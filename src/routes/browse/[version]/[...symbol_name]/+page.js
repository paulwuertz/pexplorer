...
// 		const selected_version_to_compare_param = url.searchParams.get(
// 			'symbols.selected_versions_to_compare'
// 		);
...
// 	componentData.currentSubfolders = new Set(
// 		componentData.symbols[componentData.selected_version].symbols
// 			.map((sym) => {
...
// 					sym.file,
// 					currentPathDepth,
// 					pathArr.length - currentPathDepth,
// 					trailingPath,
// 					pathArr,
// 					pathArr.length
// 				);
// 				return sym.file.startsWith(currentPath) && pathArr.length - currentPathDepth >= 2
// 					? pathArr[0]
// 					: '';
// 			})
// 			.filter((folder) => folder !== '')
// 	);
// 	componentData.currentSubfiles = componentData.symbols[
// 		componentData.selected_version
// 	].symbols.filter((sym) => {
